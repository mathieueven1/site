...
Before that, I was a PhD student from September 2021 to June 2024 under the supervision of [Laurent Massoulié](https://www.di.ens.fr/laurent.massoulie/), working on the theory and algorithms of Machine Learning.
My PhD manuscript is available [here](https://hal.science/tel-04877971v1/document).
During my PhD, I was particularly interested in optimization (in all its form: distributed, decentralized, stochastic,...), topics related to Federated Learning, gossip algorithms and high-dimensional statistics, deep learning, and the theory of deep learning.
I was awarded an accesit to the [Gilles-Kahn PhD](https://www.socinfo.fr/palmares-du-prix-de-these-gilles-kahn-2024/) prize bu the Société d'Informatique de France, sponsored by the French Académie des Sciences.
